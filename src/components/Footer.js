export default function Footer() {
    return (
        <>
            ...
            <div className="container-fluid bg-dark text-white-50 footer pt-2 mt-2 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <div className="copyright">
                        <div className="row">
                            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                                <a className="border-bottom" href="#">Your Site Name</a>, All Right Reserved. Designed By
